      ...
      <div className="mt-3 grid grid-cols-5 gap-2">
        {VALORES.map((v) => (
          <button
            ...
            className="rounded-xl bg-gray-100 py-2.5 text-xs font-bold text-gray-700 transition hover:bg-red-100 hover:text-red-700 active:scale-95 dark:bg-white/10 dark:text-gray-300 dark:hover:bg-red-500/20 dark:hover:text-red-400"
          >
